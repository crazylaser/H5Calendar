...
;(function($, window, document, undefined) {	
	...
	methods = {
        ...
        add: function (o,$this) { //显示弹框
			...
			$obj.stop().animate({'width':o.width,'height':o.height},300).removeAttr('class').addClass('animated '+c+'').show(1);
        },
        close: function (o, urls) { //关闭弹框
			...
			switch(o.effect){
				case "hide":
					$obj.stop().hide(1,_effect);
				break;
				case "fadeOut":
					$obj.stop().fadeOut(1,_effect);
				break;
				default:
					$obj.stop().hide(1,_effect);
			}
